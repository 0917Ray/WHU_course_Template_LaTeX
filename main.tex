...
\usepackage{hyperref}
\definecolor{huangwalv}{RGB}{0, 121, 124}   % 簧瓦绿
\definecolor{qiuguihuang}{RGB}{255, 163, 0} % 秋桂黄
\definecolor{donghulan}{RGB}{65, 182, 30}   % 东湖蓝
\definecolor{shuangyehong}{RGB}{225, 8, 0}  % 霜叶红
% 修改链接颜色
\hypersetup{
  colorlinks=huangwalv,
  citecolor=huangwalv,
  linkcolor=huangwalv,
  urlcolor=shuangyehong}
%%----------------------------------------正文开始-----------------------------------%%
\begin{document}
...
\begin{verbatim}
    \begin{figure}[!htbp]
        \centering
        \includegraphics[width =.4\textwidth]{figures/whu_logo1.png}
        \caption{武汉大学}
        \label{SJTU}
    \end{figure}
\end{verbatim}
